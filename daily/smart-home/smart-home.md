...
* [智能家居入门指南](smart-home.md#智能家居入门指南)
  * [概念定义](smart-home.md#概念定义)
    * [国际观点](smart-home.md#国际观点)
    * [国内观点](smart-home.md#国内观点)
  * [行业概况](smart-home.md#行业概况)
    * [供需现状](smart-home.md#供需现状)
    * [全球龙头](smart-home.md#全球龙头)
    * [国内市场](smart-home.md#国内市场)
      * [产业链](smart-home.md#产业链)
      * [龙头企业](smart-home.md#龙头企业)
      * [市场前景](smart-home.md#市场前景)
  * [组网架构](smart-home.md#组网架构)
  * [产品实操](smart-home.md#产品实操)
    * [涂鸦简介](smart-home.md#涂鸦简介)
    * [APP 安装与登录](smart-home.md#app-安装与登录)
    * [有线网关](smart-home.md#有线网关)
      * [网关配网](smart-home.md#网关配网)
    * [八键开关](smart-home.md#八键开关)
      * [开关配网](smart-home.md#开关配网)
      * [多控关联](smart-home.md#多控关联)
      * [普通开关触发场景](smart-home.md#普通开关触发场景)
    * [八键语音开关](smart-home.md#八键语音开关)
      * [更改唤醒词](smart-home.md#更改唤醒词)
      * [普通按键语音名称](smart-home.md#普通按键语音名称)
      * [场景按键语音名称](smart-home.md#场景按键语音名称)
      * [继电器锁定设置](smart-home.md#继电器锁定设置)
      * [继电器解锁设置](smart-home.md#继电器解锁设置)
    * [雷达传感器](smart-home.md#雷达传感器)
      * [设置项说明](smart-home.md#设置项说明)
    * [背景音乐主机-P6](smart-home.md#背景音乐主机-p6)
      * [P6-主机绑定](smart-home.md#p6-主机绑定)
      * [P6-同步设备和场景](smart-home.md#p6-同步设备和场景)
      * [P6-歌单设置](smart-home.md#p6-歌单设置)
      * [P6-智能场景设置](smart-home.md#p6-智能场景设置)
    * [背景音乐主机-M10](smart-home.md#背景音乐主机-m10)
      * [M10-网关绑定](smart-home.md#m10-网关绑定)
      * [M10-同步设备和场景](smart-home.md#m10-同步设备和场景)
  * [参考源](smart-home.md#参考源)
...
![家庭数量](../../.gitbook/assets/家庭数量.png)

近年来，消费者对于智能家居产品的接受度不断提高，Statista 和 Strategy Analytics 公布数据显示，**2016-2021 年，全球拥有智能家居设备的家庭数量不断增长，2021 年达 2.6 亿户**。

![细分市场](../../.gitbook/assets/细分市场.png)

分细分市场看，截至 2021 年，全球智能照明、智能安防及智能家居控制和链接用户数量均已超过 1 亿，能源管理、家庭娱乐和智能家电用户数量也超过 0.8 亿。

### 全球龙头

![alexa](../../.gitbook/assets/alexa.jpg) ![google home](../../.gitbook/assets/google-home.png) ![homekit](../../.gitbook/assets/homekit.png)

目前世界上最多用户的平台分别为 amazon 的 **alexa**，google 的 **google home** 与 apple 的 **homekit**。为解决智能家庭空间碎片化的问题，google 与 amazon、apple 和 zigbee 共同推出了 _“project connected home over ip”_ 计划。

### 国内市场

#### 产业链

![产业链图](../../.gitbook/assets/产业链图.png)

智能家居产业链上游为技术层和基础层，主要参与企业包括芯片、传感器、智能控制器等硬件供应商以及 AI 技术、云服务等软件供应商；中游为智能家居系统及设备的设计制造；下游为消费市场，主要参与者有房地产企业、家装企业、零售企业等。

#### 龙头企业

![国内龙头](../../.gitbook/assets/国内龙头.jpg)
...
![涂鸦智能](../../.gitbook/assets/涂鸦智能.jpg)

涂鸦平台产品的配置和使用主要依赖的 APP 为 **涂鸦智能**，在常见的手机应用市场搜索下载即可。

官网下载地址：[https://smartapp.tuya.com/tuyasmart/](https://smartapp.tuya.com/tuyasmart/)

_涂鸦作为开放平台，会向厂商提供全套的定制解决方案，其中就包括 APP 定制服务，因而部分品牌提供的独立 APP 可能为涂鸦换壳。只要是标注为兼容涂鸦平台，都可以采用涂鸦官方 APP 进行操控。_

首次使用 APP 需要注册并登录账号，根据页面提示操作即可。

### 有线网关

![有线网关](../../.gitbook/assets/有线网关.png)
...
![雷达传感](../../.gitbook/assets/雷达传感.png)

雷达传感器本质上是一个毫米波雷达，发射电磁波探知周围空间内的物体运动，得益于其较高的精度，可以通过人体呼吸时的微小动作确定空间内人体的存在与具体行为模式。

#### 设置项说明

![雷达说明](../../.gitbook/assets/雷达说明.png)

### 背景音乐主机-P6

![背景音乐-P6](../../.gitbook/assets/背景音乐-P6.jpg)
...
![背景音乐-M10](../../.gitbook/assets/背景音乐-M10.jpg)
