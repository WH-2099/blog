...
>
> > 例：$$C$$ 的 MRO 中存在 $$B_1$$ 和 $$B_2$$，且 $$B_1$$ 在 $$B_2$$ 之前，则在 $$C$$ 的任何子类的 MRO 中，也存在 $$B_1$$ 和 $$B_2$$，且 $$B_1$$ 在 $$B_2$$ 之前。
...
事实上呢，与 _**机器人三定律**_ 一样的是，_**MRO 三定律**_ 会在某型情况下 **产生定律间的对抗。**
...
但在使用 Python 2.2 `典型类` 的 21 世纪初，这两个问题不知道让多少开发者 _聪明绝顶_ XD！\
部分人因而生惧，冠以魔鬼和恐怖之名。
...
3. [C3 线性化算法与 MRO——理解 Python 中的多继承](http://kaiyuan.me/2016/04/27/C3\_linearization/)
